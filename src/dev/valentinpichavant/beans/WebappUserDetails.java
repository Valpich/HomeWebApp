...
public class WebappUserDetails extends SocialUser {
    ...
    public static class Builder {
        ...
        public WebappUserDetails build() {
            WebappUserDetails user = new WebappUserDetails(username, password, authorities);
